...
OFF_STTN_MODEL_PATH = os.path.join(BASE_DIR, 'models', 'sttn', 'sttn.pth')
VSR_STTN_MODEL_PATH = os.path.join(BASE_DIR, 'models', 'sttn', 'infer_model.pth')
###这个是自己训练的模型
